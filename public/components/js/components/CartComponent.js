      ...
      <div class="header__cart-item">
         ...
         <div class="header__cart-item-info">
            ...
            <div class="header__cart-item-count">
               <span class="header__cart-item-quantity">{{ cartItem.quantity }}</span> &times; <p class="header__cart-item-price">$<span>{{ cartItem.price.toFixed(2) }}</span></p>
            </div>
         </div>
         <button><i class="fa-solid fa-circle-xmark" @click="$emit('deleteItem', cartItem), $emit('countPrice', cartItem), $emit('countQuantity', cartItem)"></i></button>
      </div>   
   `
})